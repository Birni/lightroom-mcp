      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            cg_shadow_lum: { type: "number" }, cg_midtone_hue: { type: "number" },
            cg_midtone_sat: { type: "number" }, cg_midtone_lum: { type: "number" },
            cg_highlight_hue: { type: "number" }, cg_highlight_sat: { type: "number" },
            cg_highlight_lum: { type: "number" }, cg_global_hue: { type: "number" },
            cg_global_sat: { type: "number" }, cg_global_lum: { type: "number" },
