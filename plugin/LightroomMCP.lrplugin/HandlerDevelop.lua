...
local PARAM_MAP = {
    ...
    -- Color Grading
    cg_shadow_hue           = "ColorGradeShadowHue",
    cg_shadow_sat           = "ColorGradeShadowSat",
    ...
    cg_highlight_hue        = "ColorGradeHighlightHue",
    cg_highlight_sat        = "ColorGradeHighlightSat",
